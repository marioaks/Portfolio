...
---
	...
	***
	...
	<Img {...props.embeddedImages.landlordDrawTradeArea} caption="The landlord flow starts off with a single address and a customizable trade area around that address"/>
