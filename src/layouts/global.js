...
import fontFaces from "Config/style/fontFaces"
import styles from "Config/style/globalStyles";
...
const GrainyBackground = styled.div`
  position: fixed;
  left: -10vw;
  top: -10vh;
  width: 120vw;
  ...
  &:after {
    ...
    animation: ${grain} 1s steps(9) infinite;
  }
`
  ...
  return (
    <>
      ...
      {fontFaces.map(fontFace => 
        <Global styles={{"font-face": fontFace}}/>
      )}
