...
exports.createPages = async function ({ actions, graphql, reporter }) {
	...
	const { data: postsData } = await graphql(`
		query getAllMdxPosts {
			allMdx(filter: { fileAbsolutePath: { regex: "/posts/" }, frontmatter: { hidden: { ne: true } } }, sort: { fields: [frontmatter___order], order: ASC }) {
				edges {
					node {
						id
						fields {
...
exports.onCreateWebpackConfig = ({ actions, loaders, stage }) => {
	actions.setWebpackConfig({
		module: {
			rules: [stage === 'develop-html' || stage === 'build-html' ? { test: /node_modules\/paper/, use: loaders.null() } : {}]
		},
		resolve: {
			alias: {
